...
LDFLAGS = -L$(CUDA_TOP)/lib64 -lcublas -lcuda -lcudart -L$(SCL_LIB) -lscalapack -L$(OLCF_ESSL_PATH)/lib64 -lessl -Wl,-rpath=$(SLATE_TOP)/lib64 -L$(SLATE_TOP)/lib64 -lblaspp -llapackpp -lslate
